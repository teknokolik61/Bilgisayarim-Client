...
echo ============================================================================================
  ...
  IF %KURULUMMODU%==1071 ECHO KURULUM MODU 1 & GOTO :EGLENCE
  IF %KURULUMMODU%==1453 ECHO KURULUM MODU 2 & GOTO :HIKAYE
  IF %KURULUMMODU%==2023 ECHO KURULUM MODU 3 & GOTO :MULTIMULTI
